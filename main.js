(() => {
  ...
  const translations = {
    en: {
      ...
      "hero.link.cv": "CV",
      "cv.canva_title": "General CV",
      "cv.canva_sub": "Standard Profile",
      "cv.industry_title": "Industry CV",
      "cv.industry_sub": "Software & Engineering",
      "cv.research_title": "Research CV",
      "cv.research_sub": "Academia & Research",
      "hero.link.github": "GitHub",
      "hero.link.linkedin": "LinkedIn",
      "hero.link.facebook": "Facebook",
      "hero.link.orcid": "ORCID",
      "hero.link.scholar": "Scholar",
      "news.kicker": "Updates",
      "news.heading": "News",
      ...
      "about.heading": "About",
      "about.statement": "My research focuses on efficient 3D scene understanding and medical image analysis — using geometry-aware deep learning to make visual AI systems more compact, accurate, and clinically useful.",
      ...
      "education.degree": "B.Eng. in Information Technology (Specialization: Artificial Intelligence)",
      "education.meta": "2023 – Expected 2027 · Faculty of Advanced Education (FAE)",
      "education.gpa_label": "GPA",
      "education.ielts_label": "IELTS",
      "education.toeic_label": "TOEIC L&R",
    ...
    vi: {
      ...
      "hero.link.cv": "CV",
      "cv.canva_title": "CV Tổng Quan",
      "cv.canva_sub": "Hồ sơ tổng quan",
      "cv.industry_title": "CV Doanh Nghiệp",
      "cv.industry_sub": "Công nghiệp & Phần mềm",
      "cv.research_title": "CV Nghiên Cứu",
      "cv.research_sub": "Học thuật & Nghiên cứu",
      "hero.link.github": "GitHub",
      "hero.link.linkedin": "LinkedIn",
      "hero.link.facebook": "Facebook",
      "hero.link.orcid": "ORCID",
      ...
      "about.statement": "Hướng nghiên cứu của tôi tập trung vào hiểu cảnh 3D hiệu quả và phân tích ảnh y khoa — ứng dụng học sâu nhận thức hình học để làm cho các hệ thống AI thị giác gọn hơn, chính xác hơn và hữu ích hơn trong lâm sàng.",
      ...
      "education.kicker": "Nền tảng",
      "education.heading": "Học vấn",
      "education.degree": "Kỹ sư Công nghệ Thông tin (Chuyên ngành: Trí tuệ Nhân tạo)",
