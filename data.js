  ...
  projects: [
    {
      ...
      titleI18n: null,
      descEn: "Geometry-aware model compression for efficient 3D scene reconstruction.",
      descVi: "Nén mô hình dựa trên hình học cho tái dựng cảnh 3D hiệu quả.",
    ...
    },
    {
      ...
      descEn: "High-resolution retinal blood vessel segmentation using deep learning for medical imaging.",
      descVi: "Phân đoạn mạch máu võng mạc độ phân giải cao bằng học sâu cho ảnh y sinh.",
    ...
    },
    {
      ...
      descEn: "MobileNetV3 classifier with k-fold cross-validation, data augmentation, and a GUI interface.",
      descVi: "Bộ phân loại MobileNetV3 với k-fold cross-validation, tăng cường dữ liệu và giao diện GUI.",
    ...
    },
    {
      ...
      descEn: "Multi-model fusion approach for skin lesion classification on the HAM10000 dataset, combining feature extraction strategies for improved diagnostic accuracy.",
      descVi: "Phương pháp kết hợp nhiều mô hình để phân loại tổn thương da trên bộ dữ liệu HAM10000, tích hợp các chiến lược trích xuất đặc trưng để cải thiện độ chính xác chẩn đoán.",
